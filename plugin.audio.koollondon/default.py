...
def MainMenu():   
        ...
        li = xbmcgui.ListItem('[COLOR dodgerblue][B]Kool London  [/B][/COLOR] [COLOR red][B][I](Testing Live)[/B][/I][/COLOR]  [COLOR yellow][B] >>[/B][/COLOR] >>    [COLOR lime](Webcam 1)[/COLOR]', iconImage='http://s30.postimg.org/5r870dash/icon.png', thumbnailImage= 'http://s30.postimg.org/5r870dash/icon.png')
        li.setProperty('fanart_image', 'http://koollondon.com/images/stories/kool-timetable-june-2015.png')
        xbmcplugin.addDirectoryItem(handle=addon_handle, url=url, listitem=li)
